...
class TestExampleExecution:
    ...
    def test_simple_generation_execution(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            modified_content = (
                content.replace("max_iterations=5000", "max_iterations=50")
                .replace("max_iterations=3000", "max_iterations=30")
    ...
    def test_batch_generation_execution(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            modified_content = (
                content.replace("template_count = 5", "template_count = 2")
                .replace("max_iterations=3000", "max_iterations=50")
                .replace("count=20", "count=2")
    ...
    def test_custom_parameters_execution(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            modified_content = (
                content.replace("max_iterations=3000", "max_iterations=20")
                .replace("max_iterations=5000", "max_iterations=30")
                .replace("max_iterations=2000", "max_iterations=20")
                .replace("debug=False", "debug=False")
            )
    ...
    def test_custom_constraints_execution(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            modified_content = (
                content.replace("max_iterations=3000", "max_iterations=20")
                .replace("max_iterations=5000", "max_iterations=30")
                .replace("max_iterations=2000", "max_iterations=15")
                .replace("debug=False", "debug=False")
                .replace("probe_deltas = [5.0, 8.0, 12.0]", "probe_deltas = [8.0]")
                .replace("run_lengths = [2, 3, 4, 5]", "run_lengths = [3, 4]")
            )
    ...
    def test_sequence_analysis_execution(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            modified_content = (
                content.replace("sample_count=20000", "sample_count=100")
                .replace("sample_count=5000", "sample_count=50")
                .replace("sample_count=2000", "sample_count=30")
                .replace("max_iterations=5000", "max_iterations=20")
                .replace("max_iterations=3000", "max_iterations=15")
                .replace("count=20", "count=2")
                .replace("plt.show()", "# plt.show()  # Disabled for testing")
                .replace("plt.savefig", "# plt.savefig  # Disabled for testing")
            )
...
class TestExampleDependencies:
    ...
    def test_biopython_import(self):
        ...
        try:
            ...
            test_seq = "ATGCATGC"
            gc_content = gc_fraction(test_seq) * 100
...
class TestExampleOutputs:
    ...
    def test_analysis_produces_data(self):
        ...
        temperatures, gc_contents = analyze_sequence_statistics(
            sequence_length=20, sample_count=10, debug=False
        )
